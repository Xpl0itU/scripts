        ...
        for file in files:
            ...
            if extension:
                ...
                if os.path.exists(os.path.join(folder_path, extension[1:])):
                    destination_file_path = os.path.join(folder_path, extension[1:], os.path.relpath(root, source_file_path))
                    if os.path.exists(destination_file_path):
                        continue
                relative_path = os.path.relpath(root, folder_path)
                destination_folder = os.path.join(folder_path, extension[1:], relative_path)
